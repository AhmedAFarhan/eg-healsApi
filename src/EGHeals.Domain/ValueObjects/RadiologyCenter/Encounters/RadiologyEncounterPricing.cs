...
{
    public record RadiologyEncounterPricing
    {
        ...
        protected RadiologyEncounterPricing() { }

        private RadiologyEncounterPricing(ReferralDoctorCost referralDoctorCost, RadiologistCost radiologistCost, TechnicianCost technicianCost, bool isReferralDoctorCostPercentage, bool isRadiologistCostPercentage, bool isTechnicianCostPercentage, decimal cost, decimal discount, bool isDiscountPercentage)
        {
        ...
        public static RadiologyEncounterPricing Of(ReferralDoctorCost referralDoctorCost, RadiologistCost radiologistCost, TechnicianCost technicianCost, bool isReferralDoctorCostPercentage, bool isRadiologistCostPercentage, bool isTechnicianCostPercentage, decimal cost, decimal discount, bool isDiscountPercentage)
        {
            ArgumentOutOfRangeException.ThrowIfLessThan(cost, 0);
            ArgumentOutOfRangeException.ThrowIfLessThan(discount, 0);

            return new RadiologyEncounterPricing(referralDoctorCost, radiologistCost, technicianCost, isReferralDoctorCostPercentage, isRadiologistCostPercentage, isTechnicianCostPercentage, cost, discount, isDiscountPercentage);
        }
    }
}
