...
{
    public class Tenant : BaseAuditableEntity<TenantId>
    {
        ...
        public static Tenant Create(TenantId id, string nationalId, Gender gender, UserActivity userActivity,  string activityDescription)
        {
