        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_SystemUsers_OwnershipId",
                        column: x => x.OwnershipId,
                        principalTable: "SystemUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserClientApplications_SystemUsers_SystemUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUsers_NormalizedEmail",
                table: "SystemUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserClientApplications_ClientApplicationId_SystemUserId",
                table: "UserClientApplications",
                columns: new[] { "ClientApplicationId", "SystemUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserClientApplications_SystemUserId",
                table: "UserClientApplications",
                column: "SystemUserId");
